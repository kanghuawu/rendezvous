...
from .views import ElderListAPIView, ElderDetailAPIView, ElderVolunteerListAPIView, ElderVolunteerCreateListAPIView, ElderVolunteerDelete
...
urlpatterns = [
    ...
    url(r'^mylist/delete/(?P<match_id>[0-9]+)/$', ElderVolunteerDelete.as_view()),
